...
namespace s3d
{
	...
	void CRenderer2D_GL::addShape2DTransformed(const Array<Float2>& vertices, const Array<uint32>& indices, float s, float c, const Float2& offset, const Float4& color)
	{
		if (vertices.isEmpty())
		{
			return;
